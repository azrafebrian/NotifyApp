...
public class MainActivity extends AppCompatActivity {
    ...
    private void sendNotification() {
        ...
        NotificationCompat.Builder notifyBuilder = new NotificationCompat.Builder(this, CHANNEL_ID).setContentTitle("Notification Title!")
                .setSmallIcon(R.mipmap.ic_launcher_round).addAction(R.mipmap.ic_launcher, "Learn more", morePendingIntent)
                .addAction(R.mipmap.ic_launcher, "Update", updatePendingIntent).setContentIntent(notifPendingIntent);
    ...
    private void updateNotification() {
        ...
        NotificationCompat.Builder notifyBuilder = new NotificationCompat.Builder(this, CHANNEL_ID).setContentTitle("Notification Title!")
                .setSmallIcon(R.mipmap.ic_launcher_round).addAction(R.mipmap.ic_launcher, "Cancel", cancelPendingIntent)
